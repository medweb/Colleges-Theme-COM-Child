	...
	<head>
		...
		<style type="text/css">
			...
			* {
	        ...
	        /* The firstmost inner tables, which should be padded at mobile siz=
	es */
	        ...
	        /* Generic class for a table column that should collapse to 100% wi=
	dth at mobile sizes */
	        ...
	        /* Generic class for a table within a column that should be forced =
	to 100% width at mobile sizes */
