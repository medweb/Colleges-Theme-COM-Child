									...
									<tbody>
										<tr>
											<td align="center"  style="padding: 0; text-align: left; vertical-align: top;">
												<p>&nbsp;</p>
												<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/newsletter/peptalk/peptalk-logo-18.png?v=2.0.0" width="400" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" border="0" class="responsiveimgh" />
									...
									<tbody>
										...
										<tr>
											...
											<td align="center" style="padding: 0; text-align: left;">
												<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/newsletter/peptalk/peptalk-header-gallery.png" width="100" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />
												<p>&nbsp;</p>
