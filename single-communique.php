<?php
/* Template Name: COMmunique */ 
// Get the slug from the ID of the newsletter
...
$articles_per_row = 2; // number of articles per table row. the first article always spans this many columns (ie gets its own row)
get_header(); ?>
									...
									<tbody>
										<tr>
											<td align="center"  style="padding: 0; text-align: left; vertical-align: top;">
												...
												<img src="<?php bloginfo('template_url'); ?>/images/newsletter/communique/communique-logo-18.png?v=2.0.0" width="400" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" border="0" class="responsiveimgh" />
