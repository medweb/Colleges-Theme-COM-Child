...
class ucf_com_main_screen_options {

	const page = 'ucf-com-main-screen-options';
	const option_group = 'ucf-com-main-screen-group';
	const option_name = 'ucf-com-main-screen-options';
	const section_twitter = 'ucf-com-main-sceen-options-social-twitter';
	const section_instagram = 'ucf-com-main-sceen-options-social-instagram';
...
new ucf_com_main_screen_options(); 